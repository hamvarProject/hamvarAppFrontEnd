...
class MapFilterSpage extends StatefulWidget {
  @override
  _MapFiltersPageState createState() => _MapFiltersPageState();
}

class _MapFiltersPageState extends State<MapFilterSpage> {
  ...
  List<bool> isChecked3 = [false, false, false, false, false];
  List<String> title3 = [
    "کافه و رستوران",
    "پزشکی",
    "تفریحی",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Padding(
          padding:
              const EdgeInsets.only(top: 25, right: 25, left: 25, bottom: 5),
          child: Column(
            children: [
              Row(
              ...
              Column(
                children: [
                  ...
                  myCheckBox(context, isChecked3, title3, 0),
                  myCheckBox(context, isChecked3, title3, 1),
                  myCheckBox(context, isChecked3, title3, 2),
                  myCheckBox(context, isChecked3, title3, 3),
                  myCheckBox(context, isChecked3, title3, 4),
                ],
              ),
              Padding(
